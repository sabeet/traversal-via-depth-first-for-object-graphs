...
public class OutputSorter {
    ...
    static ArrayList<String> AL = new ArrayList<String>(); //instantiated static arraylist so obj can call it to store objects
    static ArrayList<String> AL2 = new ArrayList<String>(); //this is to count the number of objects only and not the superclass names
    static ArrayList<String> AL3 = new ArrayList<String>(); //this is for other classes to store values

    public static void OutputSorter(String arg1, String arg2){
        try {
            ...
            AL3.add(AL2.size()+ " objects in class Obj\n");
            ...
            for(String i : clonedOrder){ //for each entry of cloned order, we will be able to print out the total number of elements that matches clonedOrder and orderedProperly
                ...
                AL3.add(Collections.frequency(orderedProperly, i) + " objects of class " + i + "\n");
            }
